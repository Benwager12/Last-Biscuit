...
public class LastBiscuit {
    ...
    public static void main(String[] args) {
        ...
        while (barrelOne + barrelTwo > 0) {
            ...
            final boolean isOne = selectedBarrel.equalsIgnoreCase("one");
            final boolean isTwo = selectedBarrel.equalsIgnoreCase("two");
            final boolean isBoth = selectedBarrel.equalsIgnoreCase("both");
